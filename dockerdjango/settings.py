...
SECRET_KEY = 'django-insecure-a51q%)cke#w8%-x^)$a0qe^$-nws%eppz4&51%$#^ou!t=-*q(' # not default - stays in the repo for sake of tutorial
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'], # not default
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
